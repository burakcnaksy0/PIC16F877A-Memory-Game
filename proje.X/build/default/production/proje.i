...
void showSequence() {
    for (int i = 0; i < level; i++) {
        switch(sequence[i]) {
            case 1: RD0 = 1; delay_ms(showSpeed); RD0 = 0; break;
            case 2: RD1 = 1; delay_ms(showSpeed); RD1 = 0; break;
            case 3: RD2 = 1; delay_ms(showSpeed); RD2 = 0; break;
            case 4: RD3 = 1; delay_ms(showSpeed); RD3 = 0; break;
        }
...
void Lcd_Command(unsigned char cmd) {
    ...
    RC4 = (cmd >> 6) & 1;
    RC5 = (cmd >> 7) & 1;
    RC1 = 1; delay_ms(1); RC1 = 0; delay_ms(2);
    RC2 = (cmd >> 0) & 1;
    RC3 = (cmd >> 1) & 1;
    RC4 = (cmd >> 2) & 1;
    RC5 = (cmd >> 3) & 1;
